...
## Principais Tecnologias
 ...
 - **Spring Data JPA**: Exploraremos como essa ferramenta pode simplificar nossa camada de acesso aos dados, facilitando a integração com bancos de dados SQL;- **Spring Data JPA**: Exp
 - **H2**: Utilizaremos H2 como o banco de dados de teste e produção, que é rápido e fácil de configurar.
 - **Hibernate**: Utilizaremos Hibernate como o ORM que conecta seus objetos Java ao banco de dados.
 - **PostgreSQL**: Utilizaremos PostgreSQL como o banco de dados de produção, que é um banco de dados relacional poderoso e open-source.
